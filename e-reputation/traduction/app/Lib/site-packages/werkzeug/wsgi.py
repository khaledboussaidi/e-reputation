...
def get_current_url(
    ...
    >>> stream = create_environ("/?param=foo", "http://localhost/script")
    >>> get_current_url(stream)
    'http://localhost/script/?param=foo'
    >>> get_current_url(stream, root_only=True)
    'http://localhost/script/'
    >>> get_current_url(stream, host_only=True)
    'http://localhost/'
    >>> get_current_url(stream, strip_querystring=True)
    'http://localhost/script/'
    ...
    >>> iri_to_uri(get_current_url(stream))
    'http://localhost/script/?param=foo'
...
def pop_path_info(environ, charset="utf-8", errors="replace"):
    ...
    >>> stream = {'SCRIPT_NAME': '/foo', 'PATH_INFO': '/a/b'}
    >>> pop_path_info(stream)
    'a'
    >>> stream['SCRIPT_NAME']
    '/foo/a'
    >>> pop_path_info(stream)
...
def extract_path_info(
    ...
    >>> extract_path_info('http://example.com/app', '/stream/hello')
    u'/hello'
...
class ClosingIterator(object):
    ...
    that::
        ...
        return ClosingIterator(stream(environ, start_response), [cleanup_session,
                                                              cleanup_locals])
