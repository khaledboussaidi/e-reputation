...
def get_current_url(
    ...
    >>> app = create_environ("/?param=foo", "http://localhost/script")
    >>> get_current_url(app)
    'http://localhost/script/?param=foo'
    >>> get_current_url(app, root_only=True)
    'http://localhost/script/'
    >>> get_current_url(app, host_only=True)
    'http://localhost/'
    >>> get_current_url(app, strip_querystring=True)
    'http://localhost/script/'
    ...
    >>> iri_to_uri(get_current_url(app))
    'http://localhost/script/?param=foo'
...
def pop_path_info(environ, charset="utf-8", errors="replace"):
    ...
    >>> app = {'SCRIPT_NAME': '/foo', 'PATH_INFO': '/a/b'}
    >>> pop_path_info(app)
    'a'
    >>> app['SCRIPT_NAME']
    '/foo/a'
