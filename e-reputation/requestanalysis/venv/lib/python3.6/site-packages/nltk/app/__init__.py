...
try:
    ...
    warnings.warn("nltk.stream package not loaded " "(please install Tkinter library).")
else:
    ...
    try:
        ...
        warnings.warn(
            "nltk.stream.wordfreq not loaded " "(requires the matplotlib library)."
        )
    else:
...
def setup_module(module):
    ...
    raise SkipTest("nltk.stream examples are not doctests")
